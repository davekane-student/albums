...
<div class="row g-3">
  <div class="col-md-4 text-center">
    <div class="card h-100 p-3 shadow-sm">
      <h6 class="text-uppercase text-muted fw-bold">Selected</h6>
      <p id="selected-title" class="fw-semibold mb-2">Taylor Swift (2006)</p>
      <img id="selected-img" src="data/swift/taylor_swift.jpg" class="img-fluid rounded" alt="Selected Album">
    </div>
  </div>
  <div class="col-md-4 text-center">
    <div class="card h-100 p-3 shadow-sm border-success">
      ...
      <img id="similar-img" src="data/swift/evermore.jpg" class="img-fluid rounded" alt="Most Similar Album">
    </div>
  </div>
  <div class="col-md-4 text-center">
    <div class="card h-100 p-3 shadow-sm border-danger">
      ...
      <img id="different-img" src="data/swift/lover.jpg" class="img-fluid rounded" alt="Most Different Album">
    </div>
  </div>
</div>
